        ...
        static void Main(string[] args)
        {
            ...
            for( int i = 0; i < locations.Length; i++)
            {
                ...
                for(int j = i + 1; j < locations.Length; j++)
                {
                    ...
                    if(dist > distance)
                    {
                        locX = (TacoBell)locations[i];
                        locY = (TacoBell)locations[j];
                        distance = dist;
                    }
                }
            }
            Console.WriteLine("--------------------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine($"The two locations of TacoBells farthest apart with distance {distance / 1609} miles are {locX.Name} and {locY.Name}.");
            Console.WriteLine();
        }
    }
}
